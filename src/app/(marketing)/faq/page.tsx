...
export const metadata: Metadata = {
  ...
  description:
    "Answers to common questions about TStaff's hourly staffing model, pricing, where our staff are based, and how to get started."
};

const faqs = [
  {
    q: "What is TStaff?",
    a: "TStaff (Talnt Staffing) is a full-service staffing agency. We source, train, and manage staff for back-office, administrative, marketing, sales, CRM, and light technical support work, so you get help without hiring and managing someone in-house."
  },
  {
    q: "What kinds of tasks can I outsource to TStaff?",
  ...
  {
    q: "Where are TStaff's staff located?",
  ...
  {
    q: "How is TStaff different from a marketplace like Upwork or Fiverr?",
    a: "Marketplaces connect you directly with independent freelancers you vet, manage, and contract yourself. TStaff sources, trains, and manages the staff member on your behalf, so you get an ongoing team member without doing the hiring and HR work yourself."
  },
  {
    q: "Do you only work with print shops and ecommerce sellers?",
    a: "No. Print shops and ecommerce are two industries where we've built specific playbooks, but TStaff is a full-service agency working across many industries — similar in breadth to an agency like Office Beacon, scaled for growing businesses."
  },
  {
  ...
  {
    q: "Who runs TStaff?",
    a: "TStaff is owned and operated by Nirav Patel, with the Philippines office run by Angela De Juan."
  },
  {
