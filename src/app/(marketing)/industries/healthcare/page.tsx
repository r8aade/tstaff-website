    ...
    <>
      ...
      <section className="page-hero">
        ...
        <p className="page-hero__lead">
          ...
          Talnt Staffing staff handle the administrative load for $10&ndash;$25/hr, with no
      ...
      <section className="contact-cta reveal">
        <div className="contact-cta__card">
          ...
          <p>Tell us how your office runs and we&apos;ll match you with someone who fits — you train them on your tools.</p>
